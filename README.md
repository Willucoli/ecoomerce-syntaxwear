...
Para visualizar o projeto, não é necessário nenhuma instalação complexa. Basta clonar o repositório e abrir o arquivo `index.html` em seu navegador de preferência, Ou acessar o link do github pages
